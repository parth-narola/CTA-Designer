...
const colorPresets = [
  { name: "Rose Pink", bg: "#f5d0dc", stripe: "#e8b4c8", heading: "#1a1a1a", desc: "#333333" },
  { name: "Mint Teal", bg: "#a8dbd0", stripe: "#8ec9bc", heading: "#1a1a1a", desc: "#333333" },
  { name: "Warm Peach", bg: "#f0ddd0", stripe: "#e0cbb8", heading: "#1a1a1a", desc: "#333333" },
  { name: "Sky Blue", bg: "#9ecfdf", stripe: "#88bdd0", heading: "#1a1a1a", desc: "#333333" },
  { name: "Lavender", bg: "#d4c5e2", stripe: "#c2b0d4", heading: "#1a1a1a", desc: "#333333" },
  { name: "Soft Yellow", bg: "#f5e6b8", stripe: "#e8d69c", heading: "#1a1a1a", desc: "#333333" },
  { name: "Coral", bg: "#f0a8a0", stripe: "#e08e88", heading: "#1a1a1a", desc: "#333333" },
  { name: "Sage Green", bg: "#b8ccb0", stripe: "#a0b898", heading: "#1a1a1a", desc: "#333333" },
  { name: "Deep Navy", bg: "#2c3e50", stripe: "#34495e", heading: "#ffffff", desc: "#e0e0e0" },
  { name: "Charcoal", bg: "#333333", stripe: "#444444", heading: "#ffffff", desc: "#cccccc" },
];
